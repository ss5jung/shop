					...
					<div>
						...
						<form method="post" action="<%=request.getContextPath()%>/signOut<%=session.getAttribute("user")%>Action.jsp" id="signOutForm">
							<fieldset>
								...
								<input type="text" id="signOutId" name="signOutId" value="<%=loginEmployee.getEmployeeId()%>" readonly="readonly">
								...
								<button type="reset" class="btn btn-secondary" style="float: right;">취소</button>
							</fieldset>
						</form>
						<!-- signout form -->
					</div>
