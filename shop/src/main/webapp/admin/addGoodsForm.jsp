			...
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<form action="<%=request.getContextPath()%>/admin/addGoodsAction.jsp" method="post" id="addGoodsForm" enctype="multipart/form-data">
								<fieldset>
									...
									<button type="button" id="addGoodsBtn" class="btn btn-primary" style="float: right;">상품 추가</button>
								</fieldset>
							</form>
						</div>
					</div>
